...
import it.snam.ned.libs.dds.dtos.DdsPermission;
...
import it.snam.ned.libs.dds.dtos.v2.folder.FolderRequestCreate;
...
public class DocumentaleDdsDAOImpl implements DocumentaleDdsDAO {
    private static final Logger logger = Logger.getLogger(DocumentaleDdsDAOImpl.class);
    private String url;
    ...
    public DocumentaleDdsDAOImpl(String url, String username, String password, String stanza, String osname) {
        this.url = url;
        this.osname = osname;
        this.username = username;
        this.password = password;
        this.stanza = stanza;
        logger.info("@@DDS DocumentaleDdsDAOImpl.OSNAME " + osname);
    ...
    public Folder creaCartella(String uuid, String nomeCartella, String nomeClasseCartella, Map<String, Object> proprietaCartella, Folder cartellaPadre) throws Throwable {
        logger.info("@@DDS ___________ nomecartella" + nomeCartella);
        ...
        logger.info("@@DDS YYY DocumentaleDdsDAOImpl.creaCartella ___________________ nome cartella: " + nomeCartella);
    ...
    public Folder leggiCartella(String percorsoCartella) throws Throwable {
        ...
        logger.info("@@DDS _____________return folder" );
        return folder;
    }
