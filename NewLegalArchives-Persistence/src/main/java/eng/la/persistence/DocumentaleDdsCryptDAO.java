...
public interface DocumentaleDdsCryptDAO {
    ...
    //non serve public byte[] leggiContenutoDocumento(String uuid) throws Throwable;
...
//
//    public  List<Document> leggiCartella(String percorsoCartella) throws Throwable;
//
...
//    public byte[] leggiContenutoDocumento(Document documento) throws Throwable;
//
//    public void verificaCreaPercorsoCartellaEmail(String cartellaPadreEmail) throws Throwable;
//
//
