...
//import com.ibm.la.mongo.service.DdsManager;
 ...
 */
public class FileNetWrapper implements IFileNetWrapper {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(FileNetWrapper.class);
	 ...
	 * 
	 */
	public FileNetWrapper(Properties configurazione) throws Throwable{
	 ...
	 *            the password
	 */
	public FileNetWrapper(String uri, String stanza, String nomeObjectStore, String username, String password) throws Throwable{
		_uri = uri;
		_stanza = stanza;
		_username = username;
		_password = password;
	...
	private void initObjectStore() throws Throwable{
		...
		/*try{
			if(ddsManager == null){
				logger.debug("ddsManager not initialized. Initializing ... ");
				ddsManager = new DdsManager();
			}else{
				logger.debug("ddsManager already initialized.");
			}
			
			//ddsToken = ddsManager.getToken();
			
		}catch(Exception e){
			logger.error("ddsManager initialization & token retrieving - ERROR - " + e.getMessage());
			e.printStackTrace();
		}*/
		/*
		...
		try {
			...
			objectStore = conn.fetchOS(get_nomeObjectStore());
			objectStore.refresh();
	...
	public Document creaDocumento(String uuid, String titoloDocumento, String nomeClasseDocumento,
		...
		try {
			...
			throw new FileNetDocumentException(e);
		}
	}
	...
	public Folder creaCartella(String uuid, String nomeCartella, String nomeClasseCartella,
		...
		try {
			...
			throw new FileNetFolderException(e);
		}
	}
