...
public class MimeTypeUtil {
	...
	public static String checkMimeType(String fileName) {
		String methodName="checkMimeType() ";
		...
		try {
		    ...
		    logger.info(methodName+" nome file passato: "+fileName+", contenttype recuperato: "+contentType);
		} catch (Exception e) {
			logger.error(methodName+" mimetype non riconosciuto ",e);
