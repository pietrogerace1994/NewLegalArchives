...
<%
	org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger("gme.j2ee.web");

  log.debug("engsecurity VA ");
...
<div role="tabpanel"
	...
	<c:if test="${ fascicoloView.settoreGiuridicoCode != null }">
		<c:if test="${fascicoloView.settoreGiuridicoCode eq 'TSTT_16'}">
			<jsp:include page="/subviews/fascicolo/stragiudiziale_jointVenture.jsp"></jsp:include>
		</c:if> 
	</c:if>
