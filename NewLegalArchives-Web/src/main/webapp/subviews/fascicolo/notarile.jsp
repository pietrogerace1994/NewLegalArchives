									...
									<c:forEach items="${fascicoloView.listaSocieta}" var="oggetto">
										<tr>
											<td><form:checkbox value="${ oggetto.vo.id }"
													path="societaAddebitoAggiunte"></form:checkbox></td>
					...
					<div class="table-responsive" style="clear: both;">
						<table class="table table-striped table-responsive">
							...
							<tbody id="boxTipoPrestazioneNotarile" class="collapse in">
								<c:if
									test="${ not empty fascicoloView.listaTipoPrestazioneNotarile  }">
									<c:forEach
										items="${fascicoloView.listaTipoPrestazioneNotarile}"
										var="oggetto">
										<tr>
											<td><form:checkbox
													value="${ oggetto.vo.codGruppoLingua }"
								...
								<c:if
									test="${ empty fascicoloView.listaTipoPrestazioneNotarile  }">
								 	<tr>
										<td colspan="2">
