...
<div role="tabpanel"
						...
						<table class="table table-striped table-responsive">
							<thead>
								<tr style="border: 1px solid #e0e0e0">
									<th data-column-id="01" style="width: 50px">
										<button type="button" data-toggle="collapse"
											data-target="#boxSocietaProcedimento"
											class="btn   bg   waves-effect waves-circle waves-float btn-circle-mini"
											style="float: left; position: relative !important;">
											<i class="zmdi zmdi-collection-text icon-mini"></i>
										</button>
	...
	<c:if test="${ fascicoloDettaglioView.settoreGiuridicoCode != null }">
		<c:if test="${fascicoloDettaglioView.settoreGiuridicoCode eq 'TSTT_1'}">
			<jsp:include
				page="/subviews/fascicolo/giudiziale_civile_dettaglio.jsp"></jsp:include>
		</c:if>
		<c:if test="${fascicoloDettaglioView.settoreGiuridicoCode eq 'TSTT_3' }">
			<jsp:include
				page="/subviews/fascicolo/giudiziale_amministrativo_dettaglio.jsp"></jsp:include>
		</c:if>
		<c:if test="${fascicoloDettaglioView.settoreGiuridicoCode eq 'TSTT_2' }">
			<jsp:include
				page="/subviews/fascicolo/giudiziale_penale_dettaglio.jsp"></jsp:include>
		</c:if>
		<c:if test="${fascicoloDettaglioView.settoreGiuridicoCode eq 'TSTT_6' }">
			<jsp:include
				page="/subviews/fascicolo/giudiziale_arbitrale_dettaglio.jsp"></jsp:include>
		</c:if>
					...
					<div class="table-responsive" style="clear:both;">
						<table class="table table-striped table-responsive" >
							...
							<tbody id="boxVecchiOwnerFascicolo" class="collapse in">
								<c:if
									test="${ not empty fascicoloDettaglioView.utentiFascicolo  }">
									<c:forEach
										items="${fascicoloDettaglioView.utentiFascicolo}"
								...
								<c:if
									test="${ empty fascicoloDettaglioView.utentiFascicolo }">
									<tr>
										<td colspan="2">
	...
	<div class="list-group-item media">
		<div class="media-body">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<!-- Testo predefinito(in base allâ€™UL dellâ€™utente loggato allâ€™ applicazione) -->
	...
	<div class="list-group-item media">
		<div class="media-body">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" id="progettoNome" class="form-control"  value="${fascicoloDettaglioView.progettoNome }"
						readonly="true" />
	...
	<div class="list-group-item media">
		<div class="media-body">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<form:checkbox path="rilevante" cssClass="checkbox" readonly="true" />
				</div>
			</div>
		</div>
	</div>
