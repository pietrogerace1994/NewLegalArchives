...
<div role="tabpanel"
	...
	<div class="list-group-item media">
		<div class="media-body">
			<div class="form-group">
				<label for="tipoPrestazioneNotarile" class="col-sm-2 control-label"><spring:message
						...
						<table class="table table-striped table-responsive">
							<thead>
								<tr style="border: 1px solid #e0e0e0">
									<th data-column-id="01" style="width: 50px">
										<button type="button" data-toggle="collapse"
											data-target="#boxTipoPrestazioneNotarile"
											class="btn   bg   waves-effect waves-circle waves-float btn-circle-mini"
									...
									<th data-column-id="id"><spring:message
											text="??fascicolo.label.tipoPrestazioneNotarile??"
											code="fascicolo.label.tipoPrestazioneNotarile" /></th>
		...
		<div class="media-body">
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<spring:message var="lblLegaleCorrenteDesc"
						text="??fascicolo.label.legaleInternoDal??"
	...
	<div class="list-group-item media">
		<div class="media-body">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<form:input type="text" path="progettoNome" class="form-control"  readonly="true"  value="${fascicoloDettaglioView.progettoNome }"/>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" id="fascicoloPadreSelezionato" disabled
						class="form-control"
						value="${fascicoloDettaglioView.fascicoloPadreNome }"
						name="fascicoloPadreNome" />
								...
								<c:if
									...
									<c:forEach
										...
										<tr>
											...
											<td>
												<button
													onclick="dettaglioFascicolo(${fascicoloCorrelato.vo.id})"
													type="button"
													class="btn   bg   waves-effect waves-circle waves-float btn-circle-mini">
