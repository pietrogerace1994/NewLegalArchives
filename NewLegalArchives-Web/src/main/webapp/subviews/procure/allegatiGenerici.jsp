...
<div class="table-responsive" style="clear: both;">
 	...
 	<table class="table table-striped table-responsive">
		<tbody>
			<c:if test="${ not empty procureView.listaAllegatiGenerici  }">
				<c:forEach items="${procureView.listaAllegatiGenerici}"
					var="oggetto">
					<tr>
			...
			<c:if test="${ empty procureView.listaAllegatiGenerici }">
				<tr>	<script>
				...
				<form id="formAggiungiAllegatoGenerico" method="post"
					...
					<div class="form-group">
						<div class="col-md-8">
								...
								data-dismiss="modal" type="button" onclick="aggiungiAllegatoGenerico(${procureView.procureId})"
