...
<div class="table-responsive" style="clear: both;">
	...
	<table class="table table-striped table-responsive">
		<tbody>
			<c:if test="${ not empty proformaView.listaAllegatiGenerici  }">
				<c:forEach items="${proformaView.listaAllegatiGenerici}"
					var="oggetto">
					<tr><script> 
						...
						<td>
						<c:if test="${ empty proformaDettaglioView.vo.daProfEsterno || proformaDettaglioView.vo.daProfEsterno  != 'T' }">
			...
			<c:if test="${ empty proformaView.listaAllegatiGenerici }">
				<tr>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="formAggiungiAllegatoGenerico" method="post"
					...
					<div class="form-group">
						<div class="col-md-8">
							<button id="btnAggiungiAllegatoGenerico" name="btnAggiungiAllegatoGenerico"
								data-dismiss="modal" type="button" onclick="aggiungiAllegatoGenerico(${incaricoView.incaricoId})"
