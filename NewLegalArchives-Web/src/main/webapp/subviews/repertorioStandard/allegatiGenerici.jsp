...
<div class="table-responsive" style="clear: both;">
	...
	<table class="table table-striped table-responsive">
		<tbody>
			<c:if test="${ not empty repertorioStandardView.allegato  }">
				<c:forEach items="${repertorioStandardView.allegato}"
					var="oggetto">
					<tr>
			...
			<c:if test="${ empty repertorioStandardView.allegato }">
				<tr>	<script>
				...
				<form id="formAggiungiAllegatoGenerico" method="post"
					...
					<div class="form-group">
						<div class="col-md-8">
								...
								data-dismiss="modal" type="button" onclick="aggiungiAllegatoGenerico(${repertorioStandardView.repertorioStandardId})"
