...
">
				<label for="data">San Donato Milanese, <c:out
						value="${incaricoDettaglioView.dataProtocollo}"></c:out></label><br> <label
					for="unita"><c:out
						value="${incaricoDettaglioView.unitaOrganizzativa}"></c:out></label> -
				Prot.
				<form:input path="protocollo" cssClass="form-control"
					style="
    width: 100px;
    display: initial;
" />
			...
			<c:out value="${incaricoDettaglioView.professionistaSelezionato.vo.studioLegale.citta}" ></c:out>
			</div>
		</div>
	</div>
...
<div class="list-group-item media">
	<div class="media-body">
		<div class="form-group">
			...
			<div class="col-sm-10">
				<form:input path="oggettoProtocollo" cssClass="form-control" />
			</div>
		</div>
	</div>
</div>
...
<div class="list-group-item media">
	<div class="media-body">
		<div class="form-group">
			<div class="col-sm-10">
				<c:if test="${incaricoDettaglioView.fascicoloRiferimento.vo.tipologiaFascicolo.codGruppoLingua eq 'TFSC_2' || 
							  incaricoDettaglioView.fascicoloRiferimento.vo.tipologiaFascicolo.codGruppoLingua eq 'TFSC_4' ||
							  incaricoDettaglioView.fascicoloRiferimento.vo.settoreGiuridico.codGruppoLingua eq 'TSTT_2'
				}">
			facendo seguito alle conversazioni e intese intercorse,<br><br>	
				</c:if>
				
				E' presente accordo quadro?<form:checkbox path="isQuadro" value="" onclick="addQuadro();" id="quadroC"/>
				
				<div id="quadro" style="display: none;">
				<br>con espresso richiamo all&rsquo;accordo quadro con Lei sottoscritto n.<form:input path='numQuadro' cssClass='form-control' style='width: 100px;display: initial;' />
				</div>
				...
				<c:forEach items="${incaricoDettaglioView.listaSocietaAddebitoAggiunteDesc}"
					var="descrizione">
					${descrizione}<br>
				</c:forEach>
				<br>
				...
				<div class="col-sm-10">
					<form:textarea path="attivita" cssClass="form-control" id="attivita" />
				</div>
				</c:if>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<ol class="rightParentesis">
				<li>Ogni conflitto di interesse, anche potenziale, dovr&agrave;
						...
						${incaricoDettaglioView.utenteConnesso}<br> 
				...
				Rimane comunque inteso (i) che Lei avr&agrave; l&rsquo;obbligo di astenersi
					...
					<li>Il legale interno dovr&agrave; essere tempestivamente e
						...
						<c:if
							test="${incaricoDettaglioView.fascicoloRiferimento.vo.tipologiaFascicolo.codGruppoLingua eq 'TFSC_1'
							&&
							incaricoDettaglioView.fascicoloRiferimento.vo.settoreGiuridico.codGruppoLingua ne 'TSTT_2'
							}">
...
<form:input path="qualifica" cssClass="form-control"style="width: 100px;display: initial;" />  dello Studio ${incaricoDettaglioView.professionistaSelezionato.vo.studioLegale.denominazione}.  
Potr&agrave; utilizzare collaboratori a condizione che siano soci, partner o collaboratori dello Studio ${incaricoDettaglioView.professionistaSelezionato.vo.studioLegale.denominazione} e fermo restando la Sua responsabilit&agrave; per lo svolgimento e l&rsquo;esito delle attivit&agrave;.
...
La informiamo inoltre che, in conformit&agrave; con la legge applicabile Lei potr&agrave;, laddove ne sussistano i presupposti, essere iscritto nel registro delle persone che hanno accesso ad informazioni privilegiate di Snam
				...
				<br>			
					...
					<li>
					Sezione Compensi:<br>
					<form:textarea path="infoCompenso" cssClass="form-control" id="infoCompenso" />
											...
											<div class="list-group-item media">
												<div class="media-body">
													<div class="form-group">
														...
														<div class="col-md-10">
															<c:if test="${ not empty incaricoDettaglioView.listaTipoValuta  }">
																<c:forEach items="${incaricoDettaglioView.listaTipoValuta}"
																	var="oggetto">
													...
													<div class="form-group">
														...
														<div class="col-md-10">
															...
															<span class="input-symbol-euro">
																<input type="number" value="${incaricoDettaglioView.compenso}" min="0" step="1.00"
																	data-number-to-fixed="2" data-number-stepfactor="100"
																	class="form-control currency" id="compenso" name="compenso"/></span>
															</div>
														</div>
													</div>
												</div>
										...
										<div class="list-group lg-alt" id="bonus">
											<div class="list-group-item media">
												<div class="media-body">
												<c:if test="${incaricoDettaglioView.sizeBonus gt 0}">
												<input type="hidden" id="sizeB" value="${incaricoDettaglioView.sizeBonus}">
												<c:forEach items="${ incaricoDettaglioView.bonusIn }" var="bonus" varStatus="i">
												<div class="form-group bonusdiv">
														...
														<span class="input-symbol-euro">
															<input name="bonus[${i.index}].importo"
																...
																class="form-control currency bonus" value="${bonus.importo}"/></span>
														</div>
														<div class="col-xs-4">
												...
												<c:if test="${incaricoDettaglioView.sizeBonus eq 0}">
													...
													<div class="form-group">
														...
														<span class="input-symbol-euro">
															<input name="bonus[0].importo"
																...
																step="1.00" data-number-to-fixed="2"
																data-number-stepfactor="100"
																class="form-control currency bonus" /></span>
														</div>
														<div class="col-xs-4">
															<input type="text" class="form-control"
													...
													<div class="form-group bonusdiv hide" id="bonusTemplate">
														...
														<span class="input-symbol-euro">
															<input type="number" value="0" min="0"
																step="1.00" data-number-to-fixed="2"
																data-number-stepfactor="100"
																class="form-control currency bonus" name=""
																id="impB"
										...
										<div class="list-group lg-alt" id="importi">
											...
											<div class="list-group-item media">
												...
												<c:set var="annoFinale" value="${incaricoDettaglioView.saldoAnno}"  />
												<c:if test="${incaricoDettaglioView.sizeAcconti gt 0}">
												<input type="hidden" id="sizeA" value="${incaricoDettaglioView.sizeAcconti}">
												<c:forEach items="${ incaricoDettaglioView.accontiIn }" var="acconti" varStatus="y">
													...
													<div class="form-group" importi-index="${y.index}">
														...
														<span class="input-symbol-euro">
															<input name="acconto[${y.index}].importo"
																...
																step="1.00" data-number-to-fixed="2"
																data-number-stepfactor="100"
																class="form-control currency importo" /></span>
														</div>
														<div class="col-xs-4">
															<input type="text" class="form-control"
																name="acconto[${y.index}].anno" placeholder="Anno"
																readonly="true"  value="${acconti.anno}"/>
														</div>
													</div>
													</c:if>
													</c:forEach>	
													</c:if>
													<c:if test="${incaricoDettaglioView.sizeAcconti eq 0}">
													...
													<div class="form-group">
														...
														<span class="input-symbol-euro">
															<input name="acconto[0].importo"
																...
																step="1.00" data-number-to-fixed="2"
																data-number-stepfactor="100"
																class="form-control currency importo" required /></span>
														</div>
														<div class="col-xs-4">
															<input type="text" class="form-control"
													...
													<div class="form-group hide" id="importiTemplate">
														...
														<span class="input-symbol-euro">
															<input type="number" value="0" min="0"
																step="1.00" data-number-to-fixed="2"
																data-number-stepfactor="100"
																class="form-control currency importo" name=""
					...
					<c:if test="${incaricoDettaglioView.fascicoloRiferimento.vo.tipologiaFascicolo.codGruppoLingua eq 'TFSC_1'
					&&
					incaricoDettaglioView.fascicoloRiferimento.vo.settoreGiuridico.codGruppoLingua ne 'TSTT_2'
					}">
    				...
    				<c:if test="${fn:length(incaricoDettaglioView.listaSocietaAddebitoAggiunteDescLet) gt 1}">
    				alle societ&agrave; assistite che, nella fattispecie, sono: 
    				</c:if>
    				<c:if test="${fn:length(incaricoDettaglioView.listaSocietaAddebitoAggiunteDescLet) eq 1}">
    				alla societ&agrave; assistita che, nella fattispecie, &egrave;: 
    				</c:if>
    				<br>
    				<c:forEach items="${incaricoDettaglioView.listaSocietaAddebitoAggiunteDescLet}"
					var="oggetto">
					${oggetto.nome}
					<br>
					</c:forEach>
					...
					<c:if test="${fn:length(incaricoDettaglioView.listaSocietaAddebitoAggiunteDescLet) eq 1}">
					<c:out value="${incaricoDettaglioView.listaSocietaAddebitoAggiunteDescLet[0].ragioneSociale}"/>
					</c:if>
					(consultabili e stampabili sul sito internet
					<c:if test="${fn:length(incaricoDettaglioView.listaSocietaAddebitoAggiunteDescLet) gt 1}">
					${incaricoDettaglioView.snamretegasWebsite}
					</c:if>
					<c:if test="${fn:length(incaricoDettaglioView.listaSocietaAddebitoAggiunteDescLet) eq 1}">
					<c:out value="${incaricoDettaglioView.listaSocietaAddebitoAggiunteDescLet[0].sitoWeb}"/>
					</c:if>
					) e la &quot;Procedura Anticorruzione&quot; di SNAM 
					(consultabile e stampabile sul sito internet ${incaricoDettaglioView.snamWebsite}).
					...
					${incaricoDettaglioView.emailSegnalazioni}.
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" readonly
						value="${incaricoDettaglioView.nomeIncarico}" />
				</div>
			</div>
		</div>
	</div>
				...
				<div class="table-responsive" style="clear: both;">
					<table class="table table-striped table-responsive">
						...
						<tbody id="boxSocietaAddebito" class="collapse in">
							<c:if
								test="${ incaricoDettaglioView.listaSocietaAddebitoAggiunteDesc != null }">
								<c:forEach
	...
	<div class="list-group-item media">
		<div class="media-body">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" readonly
						value="${incaricoDettaglioView.professionistaSelezionato.vo.nome}" />
				</div>
			</div>
		</div>
	</div>
	...
	<div class="list-group-item media">
		<div class="media-body">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" readonly
						value="${incaricoDettaglioView.professionistaSelezionato.vo.cognome}" />
				</div>
			</div>
		</div>
	</div>
	...
	<div class="list-group-item media">
		<div class="media-body">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" readonly
						value="${incaricoDettaglioView.professionistaSelezionato.vo.studioLegale.indirizzo}" />
				</div>
			</div>
		</div>
	</div>
	...
	<div class="list-group-item media">
		<div class="media-body">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" readonly
						value="${incaricoDettaglioView.professionistaSelezionato.vo.studioLegale.partitaIva}" />
				</div>
			</div>
		</div>
	</div>
	...
	<div class="media-body">
		<div class="form-group">
			<label for="protocollo" class="col-sm-2 control-label"><spring:message
					text="??incarico.label.protocollo??"
					code="incarico.label.protocollo" /></label>
			<div class="col-sm-10">
				<form:input path="protocollo" cssClass="form-control" readonly="true" />
			</div>
		</div>
	</div>
</div>
...
<div class="list-group lg-alt">
	...
	<div class="list-group-item media">
		<div class="media-body media-body-datetimepiker">
			<div class="form-group"> 
				<label class="col-md-2 control-label" for="dataProtocollo"><spring:message
						text="??incarico.label.dataProtocollo??"
						code="incarico.label.dataProtocollo" /></label>
				<div class="col-md-10">
					<form:input id="txtDataProtocollo" path="dataProtocollo" readonly="true" 
	...
	<div class="media-body">
		<div class="form-group">
			<label for="oggetto" class="col-sm-2 control-label"><spring:message
					text="??incarico.label.oggettoProtocollo??"
					code="incarico.label.oggettoProtocollo" /></label>
			<div class="col-sm-10">
				<form:textarea path="oggettoProtocollo" cols="70" rows="8" readonly="true" 
...
<div class="list-group-item media">
	<div class="media-body">
		<div class="form-group">
			<label for="descrizioneProtocollo" class="col-sm-2 control-label"><spring:message
					text="??incarico.label.descrizioneProtocollo??"
					code="incarico.label.descrizioneProtocollo" /></label>
			<div class="col-sm-10">
				<p style="height: 250px; overflow:scroll;">
					<c:out value="${incaricoDettaglioView.descrizioneProtocollo}" escapeXml="false"/>
				</p>	
			</div>
		</div>
	</div>
...
<div class="list-group-item media">
	<div class="media-body">
		<div class="form-group">
			...
			<div class="col-sm-10">
				<form:input path="compenso" cssClass="form-control" readonly="true" />
			</div>
		</div>
	</div>
</div>
	...
	<div class="list-group-item media">
		<div class="media-body">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<form:input path="mesiCompensoStragiudiziale" cssClass="form-control" readonly="true" />
				</div>
			</div>
		</div>
	</div>
		...
		<div class="list-group-item media">
			<div class="media-body">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<form:input  path="bonusCivile1" cssClass="form-control" readonly="true"/>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="list-group-item media">
			<div class="media-body">
				<div class="form-group">
					...
					<div class="col-sm-5">
						<form:input path="bonusCivile2" cssClass="form-control" readonly="true"/>
					</div>
					<div class="col-sm-5"> 
						<form:select path="esitoBonusCivile2" cssClass="form-control" disabled="true">
		...
		<div class="list-group-item media">
			<div class="media-body">
				<div class="form-group">
					...
					<div class="col-sm-5">
						<form:input path="bonusCivile3" cssClass="form-control" readonly="true"/> 
					</div>
					<div class="col-sm-5"> 
						<form:select path="esitoBonusCivile3" cssClass="form-control" disabled="true">
							<form:option value=""></form:option>
							<form:option value="10" label="10%"></form:option>
							<form:option value="20" label="20%"></form:option>
							<form:option value="30" label="30%"></form:option>
		...
		<div class="list-group-item media">
			<div class="media-body">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<form:input path="bonusAmministrativo1" cssClass="form-control" readonly="true"/>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="list-group-item media">
			<div class="media-body">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<form:input path="bonusAmministrativo2" cssClass="form-control" readonly="true" />
					</div>
				</div>
			</div>
		</div>
		...
		<div class="list-group-item media">
			<div class="media-body">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<form:input path="bonusArbitrale1" cssClass="form-control" readonly="true"/>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="list-group-item media">
			<div class="media-body">
				<div class="form-group">
					...
					<div class="col-sm-5">
						<form:input path="bonusArbitrale2" cssClass="form-control" readonly="true"/>
					</div>
					<div class="col-sm-5"> 
						<form:select path="esitoBonusArbitrale2" cssClass="form-control" disabled="true">
							<form:option value=""></form:option>
							<form:option value="10" label="10%"></form:option>
							<form:option value="20" label="20%"></form:option>
							<form:option value="30" label="30%"></form:option>
		...
		<div class="list-group-item media">
			<div class="media-body">
				<div class="form-group">
					...
					<div class="col-sm-5">
						<form:input path="bonusArbitrale3" cssClass="form-control" readonly="true"/>
					</div>
					<div class="col-sm-5"> 
						<form:select path="esitoBonusArbitrale3" cssClass="form-control" disabled="true">
							<form:option value=""></form:option>
							<form:option value="10" label="10%"></form:option>
							<form:option value="20" label="20%"></form:option>
							<form:option value="30" label="30%"></form:option>
