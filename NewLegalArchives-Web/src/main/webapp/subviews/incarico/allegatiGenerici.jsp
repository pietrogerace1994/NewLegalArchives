...
<div class="table-responsive" style="clear: both;">
	...
	<table class="table table-striped table-responsive">
		<tbody>
			<c:if test="${ not empty incaricoView.listaAllegatiGenerici  }">
				<c:forEach items="${incaricoView.listaAllegatiGenerici}"
					var="oggetto">
					<tr>
			...
			<c:if test="${ empty incaricoView.listaAllegatiGenerici }">
				<tr>	<script>
