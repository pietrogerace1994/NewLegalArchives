...
<div class="table-responsive" style="clear: both;">
	...
	<table class="table table-striped table-responsive">
		<tbody>
			<c:if test="${ not empty progettoDettaglioView.listaAllegatiGenerici  }">
				<c:forEach items="${progettoDettaglioView.listaAllegatiGenerici}"
					var="oggetto">
					<tr>
			...
			<c:if test="${ empty progettoDettaglioView.listaAllegatiGenerici }">
				<tr>
