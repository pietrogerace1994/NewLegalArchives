...
<div class="table-responsive" style="clear: both;">
	...
	<table class="table table-striped table-responsive">
		<tbody>
			<c:if test="${ not empty progettoView.listaAllegatiGenerici  }">
				<c:forEach items="${progettoView.listaAllegatiGenerici}"
					var="oggetto">
					<tr>
			...
			<c:if test="${ empty progettoView.listaAllegatiGenerici }">
				<tr>	<script>
				...
				<form id="formAggiungiAllegatoGenerico" method="post"
					...
					<div class="form-group">
						<div class="col-md-8">
								...
								data-dismiss="modal" type="button" onclick="aggiungiAllegatoGenerico(${progettoView.progettoId})"
