...
<body data-ma-header="teal">
	...
	<section id="main">
		...
		<section id="content">
					...
					<div id="col-1" class="col-lg-12 col-md-12 col-sm-12 col-sx-12">
						...
						<div class="card">
							<div class="card-header">
									...
									<h1>
									<spring:message text="??progetto.label.ricercaProgetti??" code="progetto.label.ricercaProgetti" />	 
									</h1>
								 	<p class="text-left" style="display:block">
										...
										<a data-toggle="modal" href="#modalRicercaProgetto" class="">
			...
			<form id="openProgetto" action="./visualizza.action" method="get" style="display:none">	
	   ...
	   <jsp:include page="/views/progetto/modal-ricerca.jsp"></jsp:include>
	...
	<script src="<%=request.getContextPath()%>/portal/js/controller/ricercaProgetto.js"></script>
	<script src="<%=request.getContextPath()%>/portal/js/controller/progetto.js"></script>
