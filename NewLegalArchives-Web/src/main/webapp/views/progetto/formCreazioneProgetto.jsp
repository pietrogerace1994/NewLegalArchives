					...
					<div id="col-1" class="col-lg-12 col-md-12 col-sm-12 col-sx-12">
						<div class="card">
							<div class="card-header ch-dark palette-Green-SNAM bg">
								<h2>
									<spring:message text="??progetto.label.gestione??"
										code="progetto.label.gestione" />
								</h2>
							</div>
							...
							<div class="card-body">
								<form:form id="progettoForm" name="progettoForm" method="post"
									...
									<form:hidden path="op" id="op" value="salvaProgetto" />
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="oggetto" cssClass="form-control"
															id="txtOggetto" value="${progettoView.getVo().oggetto}" />
													</div>
												</div>
											</div>
										</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="nome" cssClass="form-control"
															id="txtNome" value="${progettoView.getVo().nome}" />
													</div>
												</div>
											</div>
										</div>
													...
													<div class="col-sm-10">
														...
														<div class="panel panel-default">
															...
															<div id="boxAllegatiGenerici"
																...
																<jsp:include
																	page="/subviews/progetto/allegatiGenerici.jsp"></jsp:include>
