...
<%
	try {
		Long idProgetto = NumberUtils.toLong(request.getAttribute("idProgetto") + "");
		ProgettoService service = (ProgettoService) SpringUtil.getBean("progettoService");
		ProgettoView view = service.leggi(idProgetto);
		...
		List<AutorizzazioneView> listaPermessiCorrenti = autorizzazioneService.leggiAutorizzazioni(idProgetto, Costanti.TIPO_ENTITA_PROGETTO);
