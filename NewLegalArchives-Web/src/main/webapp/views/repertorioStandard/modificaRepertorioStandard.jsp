						...
						<div class="card">
							<div class="card-header ch-dark palette-Green-SNAM bg">
								<% if ("true".equals(disableInVis)){ %>							
									<h2>
										<spring:message text="??repertorioStandard.label.visualizza??"
											code="repertorioStandard.label.visualizza" />
									</h2>
								<% }else{ %>
									<h2>
										<spring:message text="??repertorioStandard.label.modifica??"
											code="repertorioStandard.label.modifica" />
									</h2>
								<% } %>							
							</div>
							...
							<form:form id="repertorioStandardForm" name="repertorioStandardForm"
									...
									<div id="creaDiv">
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="nome" cssClass="form-control" maxlength="200" disabled="<%=disableInVis %>"
															id="txtNome"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="nota" cssClass="form-control" maxlength="1000" disabled="<%=disableInVis %>"
															id="txtNota"
											...
											<div class="list-group-item media">
												<div class="media-body">
													<div class="form-group">
														...
														<div class="col-sm-10">
															<form:select path="societaSelezionata" disabled="<%=disableInVis %>"
											...
											<div class="list-group-item media">
												<div class="media-body">
													<div class="form-group">
														...
														<div class="col-sm-10">
															<form:select path="idPosizioneOrganizzativa" disabled="<%=disableInVis %>"
																cssClass="form-control">
																<form:option value="">
																	<spring:message
											...
											<div class="list-group-item media">
												<div class="media-body">
													<div class="form-group">
														...
														<div class="col-sm-10">
															<form:select path="idPrimoLivelloAttribuzioni" disabled="<%=disableInVis %>"
																cssClass="form-control">
																<form:option value="">
																	<spring:message
											...
											<div class="list-group-item media">
												<div class="media-body">
													<div class="form-group">
														...
														<div class="col-sm-10">
															<form:select path="idSecondoLivelloAttribuzioni" disabled="<%=disableInVis %>"
																cssClass="form-control">
																<form:option value="">
																	<spring:message
										...
										<div class="col-sm-1">
										<button form="repertorioStandardForm" onclick="salvaRepertorioStandard()"
