					...
					<div id="col-1" class="col-lg-12 col-md-12 col-sm-12 col-sx-12">
						<div class="card">
							<div class="card-header ch-dark palette-Green-SNAM bg">
								<!-- Aggiunta breadcrumb RIDP6U9 -->
								<!-- <div class="card">
									<a href="<%=request.getContextPath()%>/organoSociale/ricerca.action?CSRFToken=<%= request.getParameter("CSRFToken") %>">
										<spring:message text="??organoSociale.label.tornaRicerca??"
											code="organoSociale.label.tornaRicerca" />
									</a> | 
									<a href="<%=request.getContextPath()%>/organoSociale/crea.action?CSRFToken=<%= request.getParameter("CSRFToken") %>">
										<spring:message text="??organoSociale.label.crea??"
											code="organoSociale.label.crea" />
									</a>
								</div>-->
								<!-- FINE Aggiunta breadcrumb RIDP6U9 -->
								<% if ("true".equals(disableInVis)){ %>							
									<h2>
										<spring:message text="??organoSociale.label.visualizza??"
											code="organoSociale.label.visualizza" />
									</h2>
								<% }else{ %>
									<h2>
										<spring:message text="??organoSociale.label.modifica??"
											code="organoSociale.label.modifica" />
									</h2>
								<% } %>							
							</div>
							...
							<form:form id="organoSocialeForm" name="organoSocialeForm"
									...
									<div id="creaDiv">
											...
											<div class="list-group-item media">
												<div class="media-body">
													<div class="form-group">
														...
														<div class="col-sm-10">
															<form:select path="idSocietaAffari" disabled="<%=disableInVis %>"
											...
											<div class="list-group-item media">
												<div class="media-body">
													<div class="form-group">
														...
														<div class="col-sm-10">
															<form:select path="tipoOrganoSociale" disabled="<%=disableInVis %>"
																cssClass="form-control">
																<form:option value="">
																	<spring:message
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="cognome" cssClass="form-control" maxlength="100" disabled="<%=disableInVis %>"
															id="txtCognome"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="nome" cssClass="form-control" maxlength="100" disabled="<%=disableInVis %>"
															id="txtNome"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="carica" cssClass="form-control" maxlength="200" disabled="<%=disableInVis %>"
															id="txtCarica"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="dataNomina" cssClass="form-control date-picker" maxlength="10" disabled="<%=disableInVis %>"
															id="txtDataNomina"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="dataCessazione" cssClass="form-control date-picker" maxlength="10" disabled="<%=disableInVis %>"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="dataScadenza" cssClass="form-control date-picker" maxlength="10" disabled="<%=disableInVis %>"
															id="txtDataScadenza"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="dataAccettazioneCarica" cssClass="form-control date-picker" maxlength="10" disabled="<%=disableInVis %>"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="emolumento" cssClass="form-control" maxlength="10" disabled="<%=disableInVis %>"
															id="txtEmolumento"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="dataNascita" cssClass="form-control date-picker" maxlength="10" disabled="<%=disableInVis %>"
															id="txtDataNascita"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="luogoNascita" cssClass="form-control" maxlength="100" disabled="<%=disableInVis %>"
															id="txtLuogoNascita"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="codiceFiscale" cssClass="form-control" maxlength="16" disabled="<%=disableInVis %>"
															id="txtCodiceFiscale"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:textarea path="note" cssClass="form-control" maxlength="1000" disabled="<%=disableInVis %>"
															id="txtNote"
										...
										<div class="col-sm-1">
										<button form="organoSocialeForm" onclick="salvaOrganoSociale()"
