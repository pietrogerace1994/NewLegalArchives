					...
					<div id="col-1" class="col-lg-12 col-md-12 col-sm-12 col-sx-12">
						<div class="card">
							<div class="card-header ch-dark palette-Green-SNAM bg">
								<h2>
									<spring:message text="??affariSocietari.label.gestione??"
										code="affariSocietari.label.gestione" />
								</h2>
							</div>
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="denominazione" cssClass="form-control" maxlength="200"
															id="txtDenominazione"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="codiceSocieta" cssClass="form-control" maxlength="1000"
															id="txtCodiceSocieta"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="capitaleSottoscritto" cssClass="form-control" maxlength="1000"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="capitaleSociale" cssClass="form-control" maxlength="1000"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="dataCostituzione" cssClass="form-control date-picker" maxlength="1000"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="dataUscita" cssClass="form-control date-picker" maxlength="1000"
															id="txtDataUscita"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="denominazioneBreve" cssClass="form-control" maxlength="1000"
											...
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="siglaFormaGiuridica" cssClass="form-control" maxlength="1000"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="formaGiuridica" cssClass="form-control" maxlength="1000"
											...
											<div class="list-group-item media">
												<div class="media-body">
													<div class="form-group">
														...
														<div class="col-sm-10">
															<form:select path="idNazione" disabled="false"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="siglaStatoProvincia" cssClass="form-control" maxlength="1000"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="siglaProvincia" cssClass="form-control" maxlength="1000"
											...
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														...
														<div class="col-sm-1">
															<form:radiobutton path="italiaEstero" value="I" />
														</div>
														...
														<div class="col-sm-1">
															<form:radiobutton path="italiaEstero" value="E" />
														</div>
											...
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														...
														<div class="col-sm-1">
															<form:radiobutton path="ueExstraue" value="UE" />
														</div>
														...
														<div class="col-sm-1">
															<form:radiobutton path="ueExstraue" value="EUE" />
														</div>
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="sedeLegale" cssClass="form-control" maxlength="1000"
															id="txtSedeLegale"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="indirizzo" cssClass="form-control" maxlength="1000"
															id="txtIndirizzo"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="cap" cssClass="form-control" maxlength="1000"
															id="txtCap"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="codiceFiscale" cssClass="form-control" maxlength="1000"
															id="txtCodiceFiscale"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="partitaIva" cssClass="form-control" maxlength="1000"
															id="txtPartitaIva"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="dataRea" cssClass="form-control date-picker" maxlength="1000"
															id="txtDataRea"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="numeroRea" cssClass="form-control" maxlength="1000"
															id="txtNumeroRea"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="comuneRea" cssClass="form-control" maxlength="1000"
															id="txtComuneRea"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="siglaProvinciaRea" cssClass="form-control" maxlength="1000"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="provinciaRea" cssClass="form-control" maxlength="1000"
															id="txtProvinciaRea"
											...
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														...
														<div class="col-sm-1">
															<form:radiobutton path="quotazione" value="SI" />
														</div>
														...
														<div class="col-sm-1">
															<form:radiobutton path="quotazione" value="NO" />
														</div>
											...
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														...
														<div class="col-sm-1">
															<form:radiobutton path="inLiquidazione" value="SI" />
														</div>
														...
														<div class="col-sm-1">
															<form:radiobutton path="inLiquidazione" value="NO" />
														</div>
											...
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														...
														<div class="col-sm-1">
															<form:radiobutton path="modelloDiGovernance" value="M" />
														</div>
														...
														<div class="col-sm-1">
															<form:radiobutton path="modelloDiGovernance" value="D" />
														</div>
														...
														<div class="col-sm-1">
															<form:radiobutton path="modelloDiGovernance" value="T" />
														</div>
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="nComponentiCDA" cssClass="form-control" maxlength="1000"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="nComponentiCollegioSindacale" cssClass="form-control" maxlength="1000"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="nComponentiOdv" cssClass="form-control" maxlength="1000"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="codiceNazione" cssClass="form-control" maxlength="1000"
															id="txtCodiceNazione"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="societaDiRevisione" cssClass="form-control" maxlength="1000"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="dataIncarico" cssClass="form-control date-picker" maxlength="1000"
															id="txtDataIncarico"
											...
											<div class="list-group-item media">
												...
												<div class="media-body">
													<div class="form-group" id="box-controllante">
														...
														<div class="col-md-1">
															<button type="button" onclick="addSocietaPro(true)" class="btn palette-Green-300 bg btn-float waves-effect waves-circle waves-float btn-circle-mini">
															...
															<c:forEach items="${affariSocietariView.sociAggiunti}" var="rAffariSocietari">
																...
																<div class="col-md-12 box-dinamik" style="margin-top:25px;">
																	...
																	<div class="col-md-1" style="left:10px;">
																		<button type="button" onclick="removeSocietaPro(${rAffariSocietari.idSocietaSocio}, true)" 
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="percentualeTerzi" cssClass="form-control" maxlength="1000"
															id="txtPercentualeTerzi"
															value="${affariSocietariView.percentualeTerzi}" />
													</div>
												</div>
											</div>
										</div>																			
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												...
												<div class="row">
													...
													<div class="col-sm-1">
														<button form="affariSocietariForm"
															onclick="salvaAffariSocietari()"
