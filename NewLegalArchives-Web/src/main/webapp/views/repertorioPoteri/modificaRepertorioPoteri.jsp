						...
						<div class="card">
							...
							<form:form id="repertorioPoteriForm" name="repertorioPoteriForm"
									...
									<div id="creaDiv">
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="codice" cssClass="form-control" disabled="<%=disableInVis%>" maxlength="10"
															id="txtCodice"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="descrizione" cssClass="form-control" disabled="<%=disableInVis%>" maxlength="200"
															id="txtDescrizione"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
													    <form:textarea path="testo" cssClass="form-control" cols="70" rows="8" disabled="<%=disableInVis%>"
															id="txtTesto"
											...
											<div class="list-group-item media">
												<div class="media-body">
													<div class="form-group">
														...
														<div class="col-sm-10">
															<form:select path="idCategoria" disabled="<%=disableInVis%>"
											...
											<div class="list-group-item media">
												<div class="media-body">
													<div class="form-group">
														...
														<div class="col-sm-10">
															<form:select path="idSubcategoria" disabled="<%=disableInVis%>"
																cssClass="form-control">
																<form:option value="">
																	<spring:message
										...
										<div class="col-sm-1">
										<button form="repertorioPoteriForm" onclick="salvaRepertorioPoteri()"
