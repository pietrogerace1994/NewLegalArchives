					...
					<div id="col-1" class="col-lg-12 col-md-12 col-sm-12 col-sx-12">
						...
						<div class="card">
							<div class="card-header ch-dark palette-Green-SNAM bg">
								<c:if
									test="${ collegioArbitraleView.collegioArbitraleId == null || collegioArbitraleView.collegioArbitraleId == 0 }">
									<h2>
										<spring:message
											text="??incarico.label.nuovoCollegioArbitrale??"
											code="incarico.label.nuovoCollegioArbitrale" />
									</h2>
								</c:if>
								<c:if
									test="${ collegioArbitraleView.collegioArbitraleId != null && collegioArbitraleView.collegioArbitraleId > 0 }">
									<h2>
										<spring:message
											text="??incarico.label.modificaCollegioArbitrale??"
											code="incarico.label.modificaCollegioArbitrale" />
									</h2>
								</c:if>
							</div>
							<div class="card-body">
								...
								<form:form name="collegioArbitraleForm" method="post"
									...
									action="salvaCollegioArbitrale.action"
									...
									<form:hidden path="op" id="op" value="salvaCollegioArbitrale" />
															...
															<form:select path="arbitroDiParteId" disabled="true"
																...
																<c:if
																	...
																	<c:forEach
																		...
																		var="oggetto">
																		<c:if test="oggetto.vo.attivo eq true">
												...
												<div class="media-body">
													<div class="form-group">
														<label for="arbitroDiParte" class="col-sm-2 control-label"><spring:message
																...
																code="incarico.label.arbitroDiParte" /></label>
														<div class="col-sm-10">
															<form:select path="arbitroDiParteId" 
																cssClass="form-control">
																<form:option value="">
																	<spring:message
																		text="??incarico.label.selezionaArbitroDiParte??"
																...
																<c:if
																	...
																	<c:forEach
																		items="${collegioArbitraleView.listaProfessionista}"
																		var="oggetto">
																		<!-- aggiungo solo i professionisti di tipo ARBITRO -->
																		<c:if
																			test="${ oggetto.vo.tipoProfessionista.codGruppoLingua eq 'TPRF_2' }">
																			<form:option value="${ oggetto.vo.id }">
																				<c:out
																					value="${oggetto.vo.studioLegale.denominazione} ${oggetto.cognomeNome}"></c:out>
																			</form:option>
									...
									<div class="list-group-item media">
										<div class="media-body">
											<div class="form-group">
												...
												<div class="col-sm-10">
													<form:input path="nominativoArbitroControparte"
														cssClass="form-control" />
												</div>
											</div>
										</div>
									...
									<div class="list-group-item media">
										<div class="media-body">
											<div class="form-group">
												...
												<div class="col-sm-10">
													<form:input path="denominazioneStudioArbitroControparte"
														cssClass="form-control" />
												</div>
											</div>
										</div>
									...
									<div class="list-group-item media">
										<div class="media-body">
											<div class="form-group">
												...
												<div class="col-sm-10">
													<form:input path="indirizzoArbitroControparte"
														cssClass="form-control" />
												</div>
											</div>
										</div>
									...
									<div class="list-group-item media">
										<div class="media-body">
											<div class="form-group">
												...
												<div class="col-sm-10">
													<form:input path="nominativoArbitroSegretario"
														cssClass="form-control" />
												</div>
											</div>
										</div>
									...
									<div class="list-group-item media">
										<div class="media-body">
											<div class="form-group">
												...
												<div class="col-sm-10">
													<form:input path="denominazioneStudioArbitroSegretario"
														cssClass="form-control" />
												</div>
											</div>
										</div>
									...
									<div class="list-group-item media">
										<div class="media-body">
											<div class="form-group">
												...
												<div class="col-sm-10">
													<form:input path="indirizzoArbitroSegretario"
														cssClass="form-control" />
												</div>
											</div>
										</div>
									...
									<div class="list-group-item media">
										<div class="media-body">
											<div class="form-group">
												...
												<div class="col-sm-10">
													<form:input path="nominativoArbitroPresidente"
														cssClass="form-control" />
												</div>
											</div>
										</div>
									...
									<div class="list-group-item media">
										<div class="media-body">
											<div class="form-group">
												...
												<div class="col-sm-10">
													<form:input path="denominazioneStudioArbitroPresidente"
														cssClass="form-control" />
												</div>
											</div>
										</div>
									...
									<div class="list-group-item media">
										<div class="media-body">
											<div class="form-group">
												...
												<div class="col-sm-10">
													<form:input path="indirizzoArbitroPresidente"
														cssClass="form-control" />
												</div>
											</div>
										</div>
								...
								<button type="submit" form="collegioArbitraleForm" onclick="salvaCollegioArbitrale()"
