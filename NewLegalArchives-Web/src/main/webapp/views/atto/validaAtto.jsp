					...
					<div id="col-1" class="col-lg-12 col-md-12 col-sm-12 col-sx-12">
						...
						<div class="card">
							<div class="card-header">
									...
									<h1>
									<spring:message text="??atto.label.attiDaValidare??" code="atto.label.attiDaValidare" />	 
									</h1>
								...
								<div class="btn-group dropup pull-right"> 
									...
									<div class="btn-group pull-right">
										...
										<ul class="dropdown-menu">
											<li><a href="javascript:void(0)" onclick="downloadListaAttiDaValidare()"><spring:message text="??atto.button.excell??" code="atto.button.excell" /></a></li>
										</ul>
									</div>
