					...
					<div id="col-1" class="col-lg-12 col-md-12 col-sm-12 col-sx-12">
						<div class="card">
							<div class="card-header ch-dark palette-Green-SNAM bg">
								<h2>
									<spring:message text="??mailingList.label.gestione??"
										code="mailingList.label.gestione" />
								</h2>
							</div>
							...
							<div class="card-body">
										...
										<li role="presentation" class='${tab1StyleAttiva}'
											...
											data-toggle="tab"> <!--<i class="fa fa-star icon-tab" aria-hidden="true"></i>-->
												<small><spring:message
														...
														code="presidionormativo.label.crea" /></small>
										</a></li>
										<li role="presentation" class='${tab2StyleAttiva}'
											...
											role="tab" data-toggle="tab"> <!--<i class="fa fa-search icon-tab" aria-hidden="true"></i>-->
												<small><spring:message
														...
														code="presidionormativo.label.modificacancellazione" /></small>
										</a></li>
									</ul>
									<!-- TAB1 CREA-->
										...
										<div role="tabpanel"
											...
											<div id="creaDiv">
												...
												<div class="list-group-item media">
													<div class="media-body">
														<div class="form-group">
															<label for="sottoCategoriaCode" class="col-sm-2 control-label"><spring:message
																	text="??email.label.sottocategoria??"
																	code="email.label.sottocategoria" /></label>
															<div class="col-sm-10">
																<form:select id="sottoCategoriaCode" path="sottoCategoriaCode"
																	...
																	<c:if
																		test="${ mailingListView.sottocategorie != null }">
																		<c:forEach
																			items="${mailingListView.sottocategorie}"
																			var="oggetto">
																			<form:option value="${ oggetto.vo.codGruppoLingua }">
																				<c:out value="${oggetto.vo.nomeCategoria}"></c:out>
																			</form:option>
																...
																<div class="table-responsive" style="clear: both;">
																	<table class="table table-striped table-responsive">
																		...
																		<tbody id="boxRubrica" class="collapse ">
																			<c:if
																				test="${ mailingListView.listaRubrica != null }">
											...
											<div id="divModCanc">
												...
												<div class="list-group lg-alt">
													<div class="list-group-item media">
														<div class="media-body">
															<div class="form-group">
																<label for="listProfEst" class="col-sm-2 control-label"><spring:message
																		text="??mailingList.label.lista??"
																		code="mailingList.label.lista" /></label>
																<div class="col-sm-10">
																	<form:select size="5" path="mailingListId"
																		onchange="caricaMailingListEdit(this.value)"
																		cssClass="form-control">
																		<c:if
																			test="${ mailingListView.listaMailingListView != null }">
																			<c:forEach
																				items="${mailingListView.listaMailingListView}"
																				var="oggetto">
													...
													<div class="media-body">
														<div class="form-group">
															<label for="nome" class="col-sm-2 control-label"><spring:message
																	...
																	code="mailingList.label.nome" /></label>
															<div class="col-sm-10">
																<form:input path="nomeMod" cssClass="form-control" />
															</div>
														</div>
													</div>
												</div>
													...
													<div class="media-body">
														<div class="form-group">
															<label for="categoriaCode" class="col-sm-2 control-label"><spring:message
																	...
																	code="mailingList.label.categoria" /></label>
															<div class="col-sm-10">
																<form:select id="categoriaCodeMod" path="categoriaCodeMod"
																	cssClass="form-control" onchange="selezionaCategoriaMod(this.value)">
																	<form:option value="">
																		<spring:message
																			text="??mailingList.label.selezionaCategoria??"
																			code="mailingList.label.selezionaCategoria" />
												...
												<div class="list-group-item media">
													<div class="media-body">
														<div class="form-group">
															<label for="sottoCategoriaCodeMod" class="col-sm-2 control-label"><spring:message
																	text="??email.label.sottocategoria??"
																	code="email.label.sottocategoria" /></label>
															<div class="col-sm-10">
																<form:select id="sottoCategoriaCodeMod" path="sottoCategoriaCodeMod"
																	cssClass="form-control">
																	<form:option value="">
																		<spring:message
																			text="??mailingList.label.selezionaCategoria??"
															...
															<div class="col-sm-10">
																<div class="table-responsive" style="clear: both;">
																	<table class="table table-striped table-responsive">
																		...
																		<tbody id="boxRubrica" class="collapse in">
																			<c:if
																				test="${ mailingListView.listaRubrica != null }">
																				<c:forEach items="${mailingListView.listaRubrica}"
																					var="oggetto">
																					<tr>
																						<td><form:checkbox value="${ oggetto.vo.id }"
																								path="nominativiAggiuntiMod"></form:checkbox></td>
																						<td>${oggetto.vo.nominativo}</td>
																						<td>${oggetto.vo.email}</td>
																					</tr>
																				</c:forEach>
								...
								<button form="mailingListForm"
									onclick="cancellaMailingList()" style="display: none"
									class="btn palette-Green-SNAM bg btn-float2 waves-effect waves-circle waves-float btnCancella">
									<i class="zmdi zmdi-delete"></i>
								</button>
								<button form="mailingListForm"
									onclick="salvaMailingList()"
