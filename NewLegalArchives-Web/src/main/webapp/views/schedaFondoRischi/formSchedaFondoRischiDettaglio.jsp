					...
					<div id="col-1" class="col-lg-12 col-md-12 col-sm-12 col-sx-12">
						...
						<div class="card">
							<div class="card-header ch-dark palette-Green-SNAM bg">
								...
								<h2>
									<spring:message text="??schedaFondoRischi.label.dettaglioSchedaFondoRischi??"
										code="schedaFondoRischi.label.dettaglioSchedaFondoRischi" />
								</h2>
							...
							<div class="card-body">
								...
								<form:form name="schedaFondoRischiForm" modelAttribute="schedaFondoRischiView"
										...
										<div class="list-group-item media">
											<div class="media-body">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input id="txtValoreDomanda" path="valoreDomanda" class="form-control" value="" disabled="true"/>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="list-group-item media">
											<div class="media-body">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<input type="text" class="form-control"   
														value="${schedaFondoRischiView.rischioSoccombenzaSelezionato.vo.descrizione}" disabled="true"/>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="media-body">
											<div class="form-group">
												...
												<div id="coperturaAssicurativaValue" class="col-sm-8" style="display: none;">
													<form:input path="coperturaAssicurativa" cssClass="form-control" readonly="true"/>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="media-body">
											<div class="form-group">
												...
												<div id="manlevaValue" class="col-sm-8" style="display: none;">
													<form:input path="manleva" cssClass="form-control" readonly="true"/>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="media-body">
											<div class="form-group">
												...
												<div id="commessaDiInvestimentoValue" class="col-sm-8" style="display: none;">
													<form:input path="commessaDiInvestimento" cssClass="form-control" readonly="true"/>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="list-group-item media">
										<div class="media-body">
											<div class="form-group">
												...
												<div class="col-sm-10">
													<form:input path="passivitaStimata" cssClass="form-control" readonly="true"/>
												</div>
											</div>
										</div>
									</div>
															...
															<div id="accordion" role="tablist"
																...
																<div class="panel panel-default">
																	...
																	<div id="boxAllegatiProfessionista"
																		...
																		<jsp:include
																			page="/subviews/schedaFondoRischi/allegatiProfessionistaDettaglio.jsp"></jsp:include>
								...
								<c:if test="${ schedaFondoRischiView.statoSchedaFondoRischiCode eq 'A' || schedaFondoRischiView.statoSchedaFondoRischiCode eq 'B' }">
								
								<legarc:isAuthorized idEntita="${schedaFondoRischiView.schedaFondoRischiId }" tipoEntita="<%=Costanti.TIPO_ENTITA_SCHEDA_FONDO_RISCHI %>"
									 tipoPermesso="<%=Costanti.TIPO_PERMESSO_SCRITTURA %>">
								
									<button form="schedaFondoRischiForm"
										onclick="modificaSchedaFondoRischi(${schedaFondoRischiView.schedaFondoRischiId})"
								...
								<button form="schedaFondoRischiForm"
									onclick="stampaScheda(${schedaFondoRischiView.schedaFondoRischiId})"
									class="btn palette-Green-SNAM bg btn-float waves-effect waves-circle waves-float" style="position: relative !important;float: right;margin-right: 17px;">
