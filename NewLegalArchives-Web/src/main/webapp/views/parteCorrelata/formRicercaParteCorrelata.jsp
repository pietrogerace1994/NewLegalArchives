...
<body data-ma-header="teal">
												...
												<div class="list-group-item media">
													<div class="media-body">
														<div class="form-group">
															...
															<div class="col-lg-3">
																<a href="#"
																	onclick="window.open('<%=request.getContextPath()%>/parteCorrelata/downloadRicerca.action','_blank'); return false;">Visualizza
																	Report</a>
															</div>
														</div>
													</div>
	...
	<script src="<%=request.getContextPath()%>/portal/js/controller/parteCorrelataRicerca.js"></script>
