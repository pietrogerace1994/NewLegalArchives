            ...
            <ul class="pull-right h-menu">
                ...
                <li class="dropdown hidden-xs">
                    ...
                    <ul class="dropdown-menu dm-icon pull-right">
                        <li class="hidden-xs"><a data-action="fullscreen" href=""><i class="zmdi zmdi-fullscreen"></i> modalità schermo intero</a></li>
                        ...
                        <div class="list-group lg-alt c-overflow">
                            ...
                            <a href="#" class="list-group-item media"> 
                                <div class="media-body">
                                    ...
                                    <small class="lgi-text">Il Fascicolo 2999 è stato aperto</small>
                                </div>
                            </a>
                                ...
                                <div class="modal-dialog modal-lg">
									...
									<div class="panel-group visible-sm" id="accordion">
    									<div class="panel panel-default" id="panel1">
            									...
            									<h3 class="panel-title"><a data-toggle="collapse" data-target="#collapseOne" href="#collapseOne">Non hai trovato quello che stavi cercando? <strong>Prova a inserire più opzioni di ricerca</strong> <i class="fa fa-plus-circle pull-right"></i></a></h3>
											</div>
