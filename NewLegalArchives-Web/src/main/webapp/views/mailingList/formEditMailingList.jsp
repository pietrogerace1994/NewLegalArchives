					...
					<div id="col-1" class="col-lg-12 col-md-12 col-sm-12 col-sx-12">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<form:form name="mailingListEditForm" method="post"
													...
													<div class="form-group">
														...
														<div class="col-sm-10">
															<form:select size="5" path="mailingListId"
																...
																<c:if test="${ mailingListView.listaMailingListView != null }">
																	<c:forEach
											...
											<div class="media-body">
												<div class="form-group">
													<label for="nome" class="col-sm-2 control-label"><spring:message
															text="??mailingList.label.nome??" code="mailingList.label.nome" /></label>
													<div class="col-sm-10">
											...
											<div class="media-body">
												<div class="form-group">
													<label for="categoriaCode" class="col-sm-2 control-label"><spring:message
															text="??mailingList.label.categoria??" code="mailingList.label.categoria" /></label>
													<div class="col-sm-10">
														<form:select id="categoriaCode" path="categoriaCode"
															cssClass="form-control">
															<form:option value="">
																<spring:message text="??mailingList.label.selezionaCategoria??"
																	code="mailingList.label.selezionaCategoria" />
															</form:option>
																<c:if test="${ mailingListView.listaCategoriaMailingList != null }">
																	<c:forEach items="${mailingListView.listaCategoriaMailingList}" var="oggetto">
											...
											<div class="media-body">
												<div class="form-group">
													<label for="rubrica" class="col-sm-2 control-label"><spring:message
															text="??mailingList.label.rubrica??" code="mailingList.label.rubrica" /></label>
													<div class="col-sm-10">
															...
															<table class="table table-striped table-responsive" >
																<thead>
																	<tr style="border:1px solid #e0e0e0">
																		<th data-column-id="01" style="width:50px"> 
																			<button  type="button"  data-toggle="collapse" data-target="#boxRubrica" 
																...
																<tbody id="boxRubrica" class="collapse in">
																	<c:if test="${ mailingListView.listaRubrica != null }">
																			<c:forEach items="${mailingListView.listaRubrica}" var="oggetto">
																			    <tr>
																					<td>
																						<form:checkbox value="${ oggetto.vo.id }"
																							path="nominativiAggiunti"></form:checkbox>
																					</td>	
																					<td>
																						${oggetto.vo.nominativo}
																					</td>
																					<td>
																						${oggetto.vo.email}
																					</td>											
								...
								<button form="mailingListEditForm" onclick="cancellaMailingList()"
									class="btn palette-Green-SNAM bg btn-float2 waves-effect waves-circle waves-float">
									<i class="zmdi zmdi-delete"></i>
								</button>
								<button form="mailingListEditForm" onclick="salvaEditMailingList()"
