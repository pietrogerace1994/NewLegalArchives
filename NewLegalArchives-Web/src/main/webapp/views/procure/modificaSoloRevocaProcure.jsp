										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="nomeProcuratore" cssClass="form-control" disabled="true"
											...
											<div class="list-group-item media">
												<div class="media-body">
													<div class="form-group">
														...
														<div class="col-sm-10">
															<form:select path="tipologia" disabled="true"
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="numeroRepertorio"
															cssClass="form-control" id="txtNumeroRepertorio" disabled="true"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input id="txtDataRevoca" path="dataRevoca" disabled="false"
															cssClass="form-control date-picker"
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="utente"
															cssClass="form-control" id="txtUtente" disabled="true"
											...
											<div class="list-group-item media">
												<div class="media-body">
													<div class="form-group">
														...
														<div class="col-sm-10">
															<form:select path="posizioneOrganizzativa" disabled="true"
																cssClass="form-control">
																<form:option value="">
																	<spring:message
											...
											<div class="list-group-item media">
												<div class="media-body">
													<div class="form-group">
														...
														<div class="col-sm-10">
															<form:select path="livelloAttribuzioniI" disabled="true"
																cssClass="form-control">
																<form:option value="">
																	<spring:message
																		text="??procure.label.seleziona??"
											...
											<div class="list-group-item media">
												<div class="media-body">
													<div class="form-group">
														...
														<div class="col-sm-10">
															<form:select path="livelloAttribuzioniII" disabled="true"
																cssClass="form-control">
																<form:option value="">
																	<spring:message
																		text="??procure.label.seleziona??"
											...
											<div class="list-group-item media">
												<div class="media-body">
													<div class="form-group">
														...
														<div class="col-sm-10">
															<form:select path="idNotaio" disabled="true"
																cssClass="form-control">
																<form:option value="">
																	<spring:message
											...
											<div class="list-group-item media">
												<div class="media-body">
													<div class="form-group">
														...
														<div class="col-sm-10">
															<form:select path="idSocieta" disabled="true"
																cssClass="form-control">
																<form:option value="">
																	<spring:message
															...
															<div id="boxAllegatiGenerici"
																...
																<jsp:include
																	page="/subviews/procure/allegatiGenerici.jsp">
																		<jsp:param name="disableInVis" value="true"/>
																	</jsp:include>
