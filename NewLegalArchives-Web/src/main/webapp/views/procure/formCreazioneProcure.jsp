					...
					<div id="col-1" class="col-lg-12 col-md-12 col-sm-12 col-sx-12">
						<div class="card">
							<div class="card-header ch-dark palette-Green-SNAM bg">
								<h2>
									<spring:message text="??procure.label.gestione??"
										code="procure.label.gestione" />
								</h2>
							</div>
							...
							<div class="card-body">
								<form:form id="procureForm" name="procureForm" method="post"
									...
									<form:hidden path="op" id="op" value="salvaProcure" />
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="nomeProcuratore" cssClass="form-control"
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="tipologia" cssClass="form-control"
															id="txtTipologia"
															value="${procureView.getVo().tipologia}" />
													</div>
												</div>
											</div>
										</div> --%>
													...
													<div class="form-group">
														<label for="tipologia"
															class="col-sm-2 control-label"><spring:message
																...
																code="procure.label.tipologia" /></label>
														<div class="col-sm-10">
															<form:select path="tipologia" disabled="false"
																cssClass="form-control">
																<form:option value="">
																	<spring:message
																		text="??procure.label.selezionaTipologia??"
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="numeroRepertorio"
															cssClass="form-control" id="txtNumeroRepertorio"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input id="txtDataConferimento"
										...
										<div class="list-group lg-alt">
											<div class="list-group-item">
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input id="txtDataRevoca" path="dataRevoca"
															cssClass="form-control date-picker"
												...
												<div class="form-group">
													...
													<div class="col-sm-10">
														<form:input path="utente"
															cssClass="form-control" id="txtUtente"
											...
											<div class="list-group-item media">
												<div class="media-body">
													<div class="form-group">
														...
														<div class="col-sm-10">
															<form:select path="posizioneOrganizzativa" disabled="false"
																cssClass="form-control">
																<form:option value="">
																	<spring:message
											...
											<div class="list-group-item media">
												<div class="media-body">
													<div class="form-group">
														...
														<div class="col-sm-10">
															<form:select path="livelloAttribuzioniI" disabled="false"
																cssClass="form-control">
																<form:option value="">
																	<spring:message
																		text="??procure.label.seleziona??"
											...
											<div class="list-group-item media">
												<div class="media-body">
													<div class="form-group">
														...
														<div class="col-sm-10">
															<form:select path="livelloAttribuzioniII" disabled="false"
																cssClass="form-control">
																<form:option value="">
																	<spring:message
																		text="??procure.label.seleziona??"
											...
											<div class="list-group-item media">
												<div class="media-body">
													<div class="form-group">
														...
														<div class="col-sm-10">
															<form:select path="idNotaio" disabled="false"
																cssClass="form-control">
																<form:option value="">
																	<spring:message
											...
											<div class="list-group-item media">
												<div class="media-body">
													<div class="form-group">
														...
														<div class="col-sm-10">
															<form:select path="idSocieta" disabled="false"
																cssClass="form-control">
																<form:option value="">
																	<spring:message
													...
													<div class="col-sm-10">
														...
														<div class="panel panel-default">
															...
															<div id="boxAllegatiGenerici"
																...
																<jsp:include
																	page="/subviews/procure/allegatiGenerici.jsp"></jsp:include>
