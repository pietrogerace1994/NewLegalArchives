    ...
    */
    ...
    function renderTableHeader()
    {
        ...
        if (this.selection)
        {
            var selectBox = (this.options.multiSelect) ?
                tpl.select.resolve(getParams.call(that, { type: "checkbox", value: "all", id:"allChek" })) : "";
    ...
    Grid.defaults = {
        ...
        templates: {
            ...
            select: "<input name=\"select\" type=\"{{ctx.type}}\" class=\"{{css.selectBox}}\" value=\"{{ctx.value}}\" id=\"{{ctx.id}}\" {{ctx.checked}} />"
        }
    };
