...
/**
 * The persistent class for the PROFORMA_WF database table.
 * 
 */
@Entity
@Table(name="PROFORMA_WF")
@NamedQuery(name="ProformaWf.findAll", query="SELECT p FROM ProformaWf p")
public class ProformaWf implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="PROFORMA_WF_ID_GENERATOR", sequenceName="PROFORMA_WF_SEQ")
	@GeneratedValue(strategy=GenerationType.AUTO, generator="PROFORMA_WF_ID_GENERATOR")
	private long id;
