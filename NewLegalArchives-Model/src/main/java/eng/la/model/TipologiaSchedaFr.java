 ...
 */
@Entity
@Table(name="TIPOLOGIA_SCHEDA_FR")
@NamedQuery(name="TipologiaSchedaFr.findAll", query="SELECT t FROM TipologiaSchedaFr t")
public class TipologiaSchedaFr implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="TIPOLOGIA_SCHEDA_FR_ID_GENERATOR", sequenceName="TIPOLOGIA_SCHEDA_FR_SEQ")
	@GeneratedValue(strategy=GenerationType.AUTO, generator="TIPOLOGIA_SCHEDA_FR_ID_GENERATOR")
	private long id;
	...
	@OneToMany(mappedBy="tipologiaSchedaFr")
	private Set<SchedaFondoRischi> schedaFondoRischis;

	public TipologiaSchedaFr() {
	}
	...
	public SchedaFondoRischi addSchedaFondoRischi(SchedaFondoRischi schedaFondoRischi) {
		...
		schedaFondoRischi.setTipologiaSchedaFr(this);
	...
	public SchedaFondoRischi removeSchedaFondoRischi(SchedaFondoRischi schedaFondoRischi) {
		...
		schedaFondoRischi.setTipologiaSchedaFr(null);
