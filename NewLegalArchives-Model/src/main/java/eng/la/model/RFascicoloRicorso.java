 ...
 */
@Entity
@Table(name="R_FASCICOLO_RICORSO") 
public class RFascicoloRicorso implements Serializable {
		private static final long serialVersionUID = 1L;

		@Id
		@SequenceGenerator(name="R_FASCICOLO_RICORSO_ID_GENERATOR", sequenceName="R_FASCICOLO_RICORSO_SEQ")
		@GeneratedValue(strategy=GenerationType.AUTO, generator="R_FASCICOLO_RICORSO_ID_GENERATOR")
		private long id;
